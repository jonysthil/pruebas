...
class OpenpayWebhookService
{
    ...
    function exec($_VAR)
    {
        ...
        {            
            ...
            // Verificamos que sea la suscripcón que estamos esperando.
            if( $json["transaction"]["subscription_id"]==$cfg["openpay"]["plan500"] || $json["transaction"]["subscription_id"]==$cfg["openpay"]["plan1000"] )
            {
