...
/* Smarty version 3.1.30, created on 2019-01-10 17:52:27
  from "C:\wamp64\www\pruebas\pay3d\libs\Openpay\assets\form.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5c37dabb8b7151_28681641',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '86d69ea18103f38c54fb953364af52b291166940' => 
    array (
      0 => 'C:\\wamp64\\www\\pruebas\\pay3d\\libs\\Openpay\\assets\\form.html',
      1 => 1541547099,
      2 => 'file',
    ),
  ),
...
function content_5c37dabb8b7151_28681641 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
>
<link rel="stylesheet" href="libs/Openpay/assets/css/styles.css" type="text/css" media="all">
					...
					<div class="modal-body">
						...
						<div class="row op-cards">
							<div class="col-sm-5">
								...
								<img src="libs/Openpay/assets/images/cards/07.jpg" alt="Visa">
								<img src="libs/Openpay/assets/images/cards/08.jpg" alt="MasterCard">
								<img src="libs/Openpay/assets/images/cards/09.jpg" alt="Carnet">
								<img src="libs/Openpay/assets/images/cards/10.jpg" alt="American Express">
							</div>
							<div class="col-sm-7 op-l-border">
								<h2>Tarjetas de Débito</h4>
								<!-- Se pueden meter las otras tarjetas, ver "/cards/" -->
								<img src="libs/Openpay/assets/images/cards/12.jpg" alt="Bancomer">
								<img src="libs/Openpay/assets/images/cards/05.jpg" alt="Santander">
								<img src="libs/Openpay/assets/images/cards/01.jpg" alt="HSBC">
								<img src="libs/Openpay/assets/images/cards/02.jpg" alt="Scotiabank">
								<img src="libs/Openpay/assets/images/cards/04.jpg" alt="Inbursa">
								<img src="libs/Openpay/assets/images/cards/06.jpg" alt="IXE">
							</div>
						...
						<div class="row op-payform">
							...
							<div class="col-sm-6 form-inline">
								...
								<div class="form-group op-bigfont">
									...
									<img class="op-cvv-icos" src="libs/Openpay/assets/images/cvv2.png" alt="cvv">
								</div>
							</div>
						</div>
						...
						<div class="col-sm-6 op-notices">
							<div class="openpay">Transacciones realizadas vía: <img src="libs/Openpay/assets/images/openpay.png" alt="OpenPay"></div>
							<div class="shield"><img src="libs/Openpay/assets/images/security.png" alt="Secure">Tus pagos se realizan de forma segura con encriptación de 256 bits</div>
							<div class="clearfix"></div>
						</div>
