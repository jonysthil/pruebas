<?php
	...
	$db_name = 'csz'; //Nombre de la Base de datos
	$db_user = 'root'; //Usuario de MySQL
	$db_pass = 'pocoyojony12'; //Password de Usuario MySQL
	
	$fecha = date("Y-m-d-H-i-s"); //Obtenemos la fecha y hora para identificar el respaldo
